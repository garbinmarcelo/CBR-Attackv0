 ...
 */
@Immutable
public class LongestCommonSubsequence implements StringDistance, LocalSimilarityFunction {
    ...
    public LongestCommonSubsequence(final double interval) {
    ...
    public double compute(final Object obj1, final Object obj2) throws NoApplicableSimilarityFunctionException {
        ...
        double greaterLenght = string1.length() > string2.length() ? string1.length() : string2.length();
        double proportion = 1/greaterLenght;
        
        
        LongestCommonSubsequence lcs = new LongestCommonSubsequence();
        
        return Math.abs((lcs.distance(string1, string2) * proportion) - 1);
    }
